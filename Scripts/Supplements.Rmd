...
```{r toeFigureS1, eval = T,  echo = F, fig.width=12, fig.height=7, fig.cap =  "World Exclusive Economic Zones used in this study as defined by the Sea Around Us and their centroids (points)."}
