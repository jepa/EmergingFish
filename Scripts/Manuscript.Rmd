...
The average ToE of the transboundary index (TI) across the emerging stocks in all EEZs analyzed is projected to be 2029 $\pm$ 26 years (Figure \@ref(fig:Figure1). Fish stocks with TI that first emerged from their historical variability in each EEZ was projected to be as early as 2006. In total, the projected transboundary index of 5,745 stocks (63% of the studied stocks) will emerge from their historical variability between 2006 and 2100. About 55% (n = 3,154) of those stocks are projected to have their shifts in distributions emerged between 2006 and 2020. Also, 96% of the world’s EEZs saw at least one stock having their distribution shifts between 2006 and 2020 (e.g. *Engraulis ringens* shared by Chile and Peru emerged in 2010). Shifts in stocks’ distributions will continue to exceed historical limits steadily towards the end of the $21^{st}$ century and are not expected to stop there (Figure \@ref(fig:Figure1)). The number of EEZs with emerging stocks is projected to increase steeply from 87% to 96% during the period of 2006 to 2020. After the mid-2020s, the rate of increase in the number EEZs slow down to an average of 0.74% per year. By 2081, all of the EEZs analyzed here will have at least one emerging stock (Figure \@ref(fig:Figure1)).


```{r Figure1, eval = T,  echo = F, fig.width = 9, fig.height=4, fig.pos= "H", fig.cap =  "Time of emergence by Exclusive Economic Zone and transboundary stock. A) Showing results in absolute numbers. B) Showing the result as a percentage of the total stocks and EEZ."}
...
Our analysis suggests that most (n = 47) countries responsible for 75% of the yearly revenue generated from transboundary species between 2005 and 2010 will see their distribution range shifts beyond historical variabilities before 2040 (Figure \@ref(fig:Figure3)). Particularly, nine of the top ten countries earning the most revenue from transboundary species, share a border. In some cases, like Indonesia, Thailand and the United States, stocks’ range shifts swill emerge by around 2030. The 47 countries that make up the bulk of the global fisheries revenues also have more stocks with range shifts emerging from historical variabilities. 

```{r Figure3, eval = T,  echo = F, fig.width=7, fig.height=8,fig.pos= "H", fig.cap =  "Average time of emergence of transboundary species per fishing entity, aggregated by colour according to region. Fishing revenue on a logarithmic scale. Showing country names for the top 90th percentile of annual fishing revenue."}
...
We compared species time of emergence within EEZs by species’ habitat association (Figure \@ref(fig:Figure4)). Each species is assigned to be associated to one of the xx habitat types based on information available from FishBase (for fish, ref) or SeaLifeBase (for invertebrates, ref). We found significant differences in the time of emergence of stocks; range shifts by their habitat association (Kruskal-Wallis, $X^2$ = 286.48, DF = 93, p < 0.001). Specifically, time of emergence of range shifts of species that are associated with pelagic-oceanic and reef habitats were significantly different than other habitat preferences (See Table \@ref(tab:TableS2)). On average, species associated with pelagic oceanic habitats e,g, tunas (*Thunnus sp.*), bathy-pelagic habitats e.g., blue whiting (*Micromesistius poutassou*) and corals (e.g., Bigeye snapper *Lutjanus lutjanus*) are projected to have an earliest time of emergence (Figure \@ref(fig:Figure4)). Species associated with bathydemersal habitats such as Alaska plaice (*Pleuronectes quadrituberculatus*) generally have an average time of emergence of range shifts that is later than 2025 (Figure \@ref(fig:Figure4)).
...
We estimated the changes in the SSR of transboundary stocks by the early (2020-2040) and the mid $21^{st}$ century (2040-2060), relative to the recent past (1951-2005) and highlighting changes below a neighbouring country’s TP. Our results suggest that 87% (n = 238) of the world EEZs will see a change in SSR below the country’s TP by 2030 (Figure \@ref(fig:Figure5)A). Globally, average changes in SSR of transboundary stocks in most EEZs are projected to be lower than 25% by the early $21^{st}$ century. The changes in SSR is expected to increase slightly towards the mid $21^{st}$ century (Figures \@ref(fig:FigureS4) and \@ref(fig:FigureS5)). However, changes in SST for specific stocks and in some EEZs are projected to be exceptionally high. For example, Guatemala is sharing *Panulirus gracilis* stock with Mexico, and Guatemala’s share is projected to increase by >50% from 12% to 26% by the early $21^{st}$ century. By the early $21^{st}$ century, the percentage of transboundary stocks per EEZ that will see a change in SSR above the country’s TP historical distribution  (e.g., $\Delta{SSR} > \mu \pm \sigma$) will be relatively large (global mean of 69% of stocks in an EEZ). 
