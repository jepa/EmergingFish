...
author: 'Authors: Juliano Palacios-Abrantes^1*^, Thomas L. Frölicher^2,3^, Gabriel Reygondeau^1^, U. Rashid Sumaila^1^, Alessandro Tagliabue^4^, Colette C.C. Wabnitz^1,5^, and William W.L. Cheung^1^'
...
```{r toeFigure3, eval = T,  echo = F, fig.width=10, fig.height=8,fig.pos= "H", fig.cap =  "Average range shift of transboundary stocks and corresponding fishing revenue per country. Countries are coded according to different colored symbols representative of 5 distinct regions. Horizontal line separates countries above and below the 75th percentile of annual fishing revenue. Showing country names for those within the top 75th percentile projected to have an average shift within 5 years after the 2030 deadline of the Sustainable Development Agenda."}
...
We estimated the intensity of the distributional shift of transboundary stocks in terms of changes in catch proportion by 2030 (2020-2040) and 2050 (2040-2060), relative to the recent past (1951-2005). Findings show that by 2030, the global average catch proportion of transboundary stocks that are projected to change beyond the EEZ’s historic proportion is 59% ± 17% (Fig. \@ref(fig:toeFigure4)A). Moreover,  85% (n = 239) of the world EEZs would have experienced changes in catch proportion of transboundary stocks by 2030. Changes in catch proportion are expected to become more common and intense slightly towards the mid -21st century at both the stock and EEZ level (Figs. S\@ref(fig:toeFigureS3) and S\@ref(fig:toeFigureS4)).
...
```{r supplements, child = '../Scripts/Supplements.Rmd', eval = F}
