...
**While the total number of shifting stocks is important for fisheries management, having high-valuable stocks shifting sooner could be a much bigger concern than having many low-value stocks shifting. Thus, we looked at the year of range shift of the top five most valuable transboundary stocks of each country (New Fig 4). On average, countries are projected to see a range shift of the top five most valuable stocks by 2038 $\pm$ 25 years under threshold two (2028 $\pm$ 22 years under threshold one). Moreover, our projections suggest that these high value stocks are already shifting in 52 (27%) coastal nations under threshold two (n = 85 44% under threshold one), with the regions of Latin America and the Caribbean (n = 63), Sub-Saharan Africa (n = 59), South-eastern Asia  (n = 28), and Polynesia (n = 19) presenting the larger number of shifting stocks (25% of total high value stocks).** 
...
**Shifts in the SSR of the top 5 most valuable transboundary stocks of each country are projected to be 61 $\pm$ 18% by 2030 and 72 $\pm$ 17% by 2050 in 83% of the world's EEZs (Figure SX). In some cases, the SSR of one EEZ is projected to increase more than double relative to their neighbors (e.g., from 10% to 30% SSR). Some of these EEZs include Guatemala gaining from Mexico in the Pacific, Cyprus from Greece and Turkey in the Mediterranean Sea, and Russia from Norway and Japan in the Barents Sea and Western Pacific, respectively**
