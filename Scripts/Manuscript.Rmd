...
We performed a multiple linear regression analysis to a series to explain the ToE of each species in each EEZ. Specifically, each species within an EEZ was classified based on the habitat preference [@REF] and catch trend [@FishForVisa]. Moreover, each EEZ was classified based on the continental [@REFUN] and biome [@Gabs] location. Finally, we also include the ToE of both bottom and sea surface temperature. We hypothesize that all of these factors would have significant influence in the time of emergence of transboundary stocks. Finally, we ran a series of ANOVAS to test continental and habitat preference ToE differences betwwn transboundary species.
...
We estimated the time of emergence between neighbouring EEZs for 633 transbboundary stocks. Since 2006, 87% of the world EEZs have already seen at least one emerging stock and 60% of the transboundary species analyzed have emerged in at least one neighbouring EEZ (e.g. Peruvean anchoveta emerged in 2010 between Chile and Peru). The cumulative sum of emerging stocks will have a steeper increase untill 2040 where the increment wil be slightly less intense. Similarly, for the number of EEZs, the increment curve seem to flattern by 2020. By 2081, all of the EEZs analyzed here will have at least one emerging stock while 2097 will be the year where all 633 stocks have emerged in at least one neighbouring EEZ (Fig. 2). 
...
The regional patterns of ToE suggest that most stocks will emerge by early 21st with many stocks in the Americas and Oceania already emerging. For the larger fisheries of the world in terms of revenue representig 75 percentile, ony the USA will see an average ToE before 2030 while fisheries in all other top fishing countries will be emerging within the following 10 years.
...
The mean ToE of transbounudary species varied significantly according to the geographic region of the neighbouring EEZs (one-way ANOVA, *DF*(15,5478) = 18.64, *p* < 0.001, $\alpha$ = 0.05) (Fig. 5). Specifically, for species in EEZs of Easter Asia and Wetern Europe who have the latest average ToE across all habitat types (2041) and Polynesia who has the earliest everage ToE across all habitats (2018). Other regions like Wester Europe (regional average 2035) and Latin America and the Caribbean (regional average 2021) also significantly differe from other regions (*See Table Sup X for full statistics*). When looking specifically at habitat association, we also found significant differences on ToE (one-way ANOVA; *DF*(7,5041) = 12.68, *p* < 0.001, $\alpha$ = 0.05). Specifically, the ToE of pelagic-oceanic species is significantly different (*p* < 0.001) to that of bathydemersal, benthopelagic, demersal, and pelagic-neritic while the ToE of reef associated species is significantly different (*p* < 0.001) than bathydemersal, bethopelagic and demersal species (*See Table Sup XX for full statistics*).
...
We hypothesize that species environmental preferences (e.g. presence in sertain biomes and habitat), climate change effects on water temperature, human drivers (e.g. catch rate), and latitudinal gradient would have significant influence in the time of emergence of transboundary stocks (Table 1). Results from the multiple linear regression analysis show a significant relation between ToE of transbounuadry stocks and latitudinal gradient (*p* > 0.001), **biome2** (*p* = 0.006) and speicies habitat association (Table 1).



# Discussion

The combination of the time of emergence and the revenue participation of the species could shed a light in the importance of the time of emergence in terms of management. For example, we identified that in Peru 12 species will emerge by 2038 in average, representing 92% of the countriy's fishing value. Morevoer, our results show that Peruvean anchoveta, the second largest fishery of the world [@SOFIA] and the main fishery in Peru [@REF] have already emerged (2010), with its stock share ratio benefititng Chile (Fig. 1).

Form all siginificantly differnt variables, only latitudinal gradient postpone the ToE suggesting that the ToE will happen first at equatorian latitudes and later towards the poles.