...
We found no clear pattern in the direction of change of future SSR under a high emission climate change scenario by 2030 relative to present (Fig. 1). Previous modelling exercises predicted an overall poleward shift in species distributions towards the end of the $21^{st}$ century [@Cheung; @Poloczanska:2016kk; @ETC]. Poleward shifts in SSR can be seen in some regions of the world with relative large EEZs and few boundaries like the North East Pacific. However, even here, Alaska's EEZ is expected to loose to Canada in the south. This is likely the effect of the geographical barriers [@Cheung:2015fm; @Kleisner:2016je] as fish cannot move north due to the land mass [@Cheung:2015fm]. Contrarily, the Eastern Tropical Pacific will see an equatorial shift with EEZs from Mexico to Ecuador loosing SSR to their southern neighbors. This shift is consistent with regional modeling studies suggesting that by mid $21^{st}$ century marine species will shift between 50 and 100 km southward of Mexico's EEZ towards Peru under a high emission climate change scenario [@TayClarkeChp2]. Similarly, poleward shifts patterns are hard to identify in regions where EEZs are relatively small like the south west Atlantic. The influence of local processes such as upwelling systems [@REF; @TayClarkeChp2] and local currents [@REF; @TayClarkeChp2] could be influencing the re-distribution of marine species in these two regions. Finally, in regions where EEZs are both small and with multiple borders like the Caribbean or North East Atlantic, changes in SSR will have no unidirectional pattern but rather present a complex network of changes. Despite these regions been already highly connected by both fish adult migration [@REF] and larvae dispersal [@Ramesh:2019va], our results suggest that distributional changes will still happen influencing the SSR of local fisheries. 

Our results suggest that most of the EEZs of the world and more than half of the transboundary species already emerged since the early 2000s (Fig. 2). Shifting species distribution  has been documented in several regions and for different species [@Poloczanska:2016kk]. In the early 2000s Humboldt squid (*Dosidicus gigas*) substantially expanded its geographic range reaching Californian waters in the Eastern North Pacific [@Zeidberg:2007gs]. In the North East Atlantic, the emergence of Atlantic mackerel (*Scomber scombrus*) in Icelandic waters in 2010, lead to years of unsettled international conflict between fishing nations [@Spijkers:2017ij]. The large amount of transboundary species emerging since early 2000s aligns with the time of emergence of several environmental variables (e.g. temperature, oxygen, $CO_2$) that influence the distribution of marine species [@Roggers:2015jq; @Keller:2014jv; @Frolicher:2016dg; @Mahlstein:2011fy]. It has been estimated that since the early 2000s, SST and oxygen ($O_2$) have emerged in 79% and 22.6% of the global ocean, respectively, and by 2080 SST will have emerged in 90% of the global ocean while $O_2$ will have doubled [@Rodggers:2015j]. 

Regional differences in ToE are likely the result of environmental factors and the characteristics of political boundaries. The tropics are the most species-rich biome of the global ocean [@Reygondeau:2019no] and showed the larger number of emerging species, specifically between latitudes $10^o$S and $45^o$N (Fig. 3). Historical trends suggest that both tropical Atlantic and Pacific oceans have experienced the greatest levels of warming since 2006 [@IPCC:2019tn; @Roemmich:2015id]. Similarly, equatorial regions have potentially experienced some of the largest declines in $O_2$ [@IPCC:2019tn]. Consequently, species living in these habitats that cannot cope with changing oceans will have too move towards more suitable waters [@Poloczanska:2016kk]. In addition to the environmental pressure from climate change, latitudes $10^o$S and $45^o$N comprise areas with a complex system of small EEZs with many borders (e.g. The Caribbean and the South China Sea). The time and number of emerging stocks decreases as we move away from the equator and into temperate-polar biomes with only a peak related to the Baltic and North seas.
...
<!-- Furthermore, as we continue to enter the $21^{st}$ century, commercial marine species are expected to continue shifting (mostly poleward) potentilly compromising shared stocks management. By the end of the century, all EEZs of the world are proyected to have at least one new transboundary species with some of them having over 10 new stocks [@Pinsky]. Consequently, as species occupy new waters they leave historic areas and so, xx% of species are expected to exit EEZs by the end of che century [@Oremus]. This entering and exicting national jurisdicions will complicate fisheries management potentially creating confllict between neighboring nations [@Pinksy @Oremus:2020id]. --> 
