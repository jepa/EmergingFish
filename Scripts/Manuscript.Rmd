...
We estimated the intensity of the distributional shift of transboundary stocks in terms of changes in catch proportion by 2030 (2020-2040) and 2050 (2040-2060), relative to the recent past (1951-2005) (see Methods). Findings show that by 2030, the global average catch proportion of transboundary stocks that are projected to change beyond the EEZ’s historic proportion is 59% ± 17% (Fig. \@ref(fig:toeFigure4)A). Moreover,  85% (n = 239) of the world EEZs would have experienced changes in catch proportion of transboundary stocks by 2030. Changes in catch proportion are expected to become more common and intense slightly towards the mid -21st century at both the stock and EEZ level (Figs. \@ref(fig:toeFigureS3) and \@ref(fig:toeFigureS4)).
