...
dashed_lines <- tibble(
  x = c(2030,2050,2070),
  label = c("UN 2030 Agenda","Mid range shift   ","Late range shift   ")
)
...
Labels_data <- tibble(
  x = c(2030,2050,2070,2007),
  y = c(-5.8,-5.8,-5.8,Percentile_value$x+.1),
  label = c("UN 2030 Agenda", "Mid shift","Late shift","Fisheries > 75th percentile")
)
...
ggplot(Buble_data) +
  ...
  geom_vline(xintercept = c(2030,2050,2070), color = "grey50", size = 0.5, linetype = "dashed") +
