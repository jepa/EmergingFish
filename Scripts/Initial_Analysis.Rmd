...
# Prop_resultsb <- my_path("R",name="proportion_change_2005.csv", read=T)
...
Labels_data <- tibble(
  ...
  label = c("Early shift", "Late shift","Fisheries > 75th percentile")
)
...
ggplot(Buble_data) +
  ...
  # right side labels
  geom_label_repel(data = subset(Buble_data, mean_yr > 2045 & sum_value_bi >= 0.90),
                  aes(
                    x = mean_yr,
                    y = log_value,
                  ...
                  box.padding = 0.2,
                  fill = "NA",
                  nudge_x = 2075 - subset(Buble_data, mean_yr > 2045 & sum_value_bi >= 0.90)$mean_yr,
                  segment.size  = 0.1,
  ...
  geom_label_repel(data = subset(Buble_data, mean_yr < 2045 & sum_value_bi >= 0.90),
                  ...
                  box.padding = 0.2,
                  fill = "NA",
                  nudge_x = 2025 - subset(Buble_data, mean_yr < 2045 & sum_value_bi >= 0.90)$mean_yr,
                  segment.size  = 0.1,
                  segment.color = "grey50",
                  direction     = "y",
                  hjust         = 1
...
### Median numbef of stocks changing in each time step
