...
```{r GetCentroids, eval = F, echo = T}

GetCentroids <- function(taxon_key,year, data_type = "Catch", ensamble, path, Neighbours, eez_centroid){
...
TransIndex <- function(Centroids,Ids){
