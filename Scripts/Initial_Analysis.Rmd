...
lat_am_map <- ggplot() +
  ...
  scale_color_gradientn(name= "Changes in catch proportion and changing stocks (%)",
                        colours = pal,
                        limits = c(0,max(Lat_am_data$percentage)),
                        breaks = seq(0,max(Lat_am_data$percentage),10)
  ) +
  scale_fill_gradientn(name= "Changes in catch proportion and changing stocks (%)",
                       colours = pal,
                       limits = c(0,max(Lat_am_data$percentage)),
...
ggsave(filename = "lat_am_mid.png",
       lat_am_map,
       width = 6,
       height = 6)
...
EU_map <- ggplot() +
  ...
  scale_color_gradientn(name= "Changes in catch proportion and changing stocks (%)",
                        colours = pal,
                        limits = c(0,max(EU_data$percentage)),
                        breaks = seq(0,max(EU_data$percentage),10)
  ) +
  scale_fill_gradientn(name= "Changes in catch proportion and changing stocks (%)",
                       colours = pal,
                       limits = c(0,max(EU_data$percentage)),
