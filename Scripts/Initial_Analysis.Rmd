...
Note this chunk needs the previous one to be ran up to the forloop
...
## --------------- ##
  ...
  p <- ggdraw() +
    draw_plot(eez_map, x = 0, y = 0.5, width = 1, height = 0.5) +
    # Regional boxplot
    draw_plot(land_map, x = 0, y = 0, width = 1, height = 0.5) +
    # Labels
    draw_plot_label(label = c("A", "B"), 
                    size = 20,
                    x = c(0, 0), 
