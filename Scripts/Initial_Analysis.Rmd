...
Path <- paste(data_path,"DBEM/",sep="")
world_grid <- tibble(index = seq(1,259200,1))
Neighbours <- read_excel("Temporal_Data/Spatial/EEZ_Neighbour_List.xlsx") %>% 
  clean_names()
Transboundary_spp <- read.csv("~/GitHub/TransEmergence/Temporal_Data/Species/Transboundary_spp.csv") %>% clean_names() 
