...
taxon_list <- unique(Transboundary_spp$taxon_key)[1:15]
...
Average_data <- Dem_pel %>% 
  ...
  mutate(regional_average="average")
...
ggplot(Dem_pel) +
  ...
  facet_wrap(~un_sub_region,scales = "free") +
  scale_fill_viridis("Habitat preference",
                     discrete = T) +
  scale_color_grey("Regional average") +
  xlab("") +
