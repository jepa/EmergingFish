...
TransIndex <- function(Centroids, # Expecting the results from the GetCentroids function
  ...
  return(Final_Result)
    ...
    # name_raw <- paste(my_path("R",extra_path = "/Emergence_alt_sens_raw/"),taxon,"_emergence_raw.csv",sep="")
    # 
...
GetTransIndex <- function(taxon_key,
  ...
  Step_one <- bind_rows(
    ...
    name <- paste(my_path("R",extra_path = "/Emergence_alt_sens_sd/"),taxon_key,"_emergence.txt",sep="")
