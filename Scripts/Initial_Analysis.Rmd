...
top_stocks_per_country <- Eme_Res %>% 
  ...
  # Select top 10 most valuable stocks
...
##### New Fig. 4. Top shifting stocks/EEZs weighted (proportion)

```{r, top_stocks_eez, eval = F, echo = F}

Value_map_data %>% 
  group_by(variable,tresh) %>% 
  top_frac(0.10,participation) %>% 
