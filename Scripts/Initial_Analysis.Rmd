...
sens_paths <- list.files("~/Desktop/Sens_analysis/Emergence_alt_sens",full.names = T)

# Load all sp in one table
Eme_Alt_Res <- bind_rows(lapply(sens_paths, fread)) %>% 
  mutate(method= "alt") %>% 
  left_join(Neighbours,
            by = c("eez_name","eez_neighbour")
  ) %>% 
...
# method emerging_stocks prop_total
# alt                158       85.9
# org                147       79.9
...
# alt    2054.  29.2  2007  2099
# org    2029.  25.4  2006  2098
