...
- **Response:** The main structure was following the journal's guideline. We have now included a summarized version of the methods in the main article. Please see line **XXX** of page **XX*.*
...
- **Response:** Thank you, we have adopted the suggested approach. It reads now in line 14 of page 1 of the revised manuscript: "*Using global climate-fisheries model simulations, we show that 78% the world’s international boundaries will experience a shifting transboundary stock by 2030*".
...
- **Response:** Thank you for noticing this. We have changed the wording to reflect this comment in the revised manuscript. 
