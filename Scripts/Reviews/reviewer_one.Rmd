...
- **Response:** Thank you very much for commenting on our figures. Here, we provide responses to the two large scale questions you provide and below we respond the finer scale points. We hope that this clarifies all of your comments. 
 ...
 - **Regarding the bi-lateral agreements**, this is a great question that, unfortunately, we cannot respond at this moment. Currently, there is only one database on bi/multi-lateral agreements produced by Oremus *et al* (2020). On their paper, the authors "analysed 127 publicly available international fisheries agreements in the South Pacific, Southeast Asia, South Asia, Northwest Africa, and Central America and the Caribbean" and "For each agreement, we [the authors] recorded the following information... If relevant, to which specific stock or species the agreement pertained". We contacted Dr. (Kimberly) Oremus who provided  the mentioned data-set. However, non of the 127 treaties have identified subjects at the species level (except for bigeye, skipjack and yellowtail tunas). Thus, we were unable to match the stocks with existing agreements. 

We hope that the reviewer understands the complexity of building such database and that this exercise falls outside the scope and stage of our current analysis. We agree that having such information would increase the manuscript impact, but, would not necessarily affect our results, nor the message we want to covey (Ultimately Oremus *et at* state it very clearly in their paper, "None of the 127 agreements contains language that is directly related to climate change, range shifts or stock exits").
...
- **Response:** Similarly, we do not have space to discuss this here. Please note that we discuss management plans on the paragraph starting on line *XXX* of page *XX*.
...
- **Response:** We have changed this sentence to reflect the suggestion, it now reads: *Marine species’ distributions mainly reflect species’ preferences for discrete environmental conditions (2).*
...
- **Response:** There is not a vast documentation on shifts in the distribution of transboundary species (i.e., specifically from one EEZ to another). This is partially because, from a scientific perspective, there is not enough standardized data to track changes across countries (See Maureaud *et all*, 2021 below). Mapping these shifts is out of the scope of the current project as there is an ongoing effort to document the global hotspots of transboundary species. That being said, in the section "High present-day climate risk of on transboundary fisheries management" we describe early shifts in the shared distribution of transboundary stocks including the cases of Humboldt squid (*Dosidicus gigas*) and Atlantic mackerel (*Scomber scombrus*) both in the early 2000s. Moreover, we have included a couple of other examples of shifts reported in neighbouring countries. It reads on line **XX** of page **X** of the revised manuscript: *Early range expansions across international jurisdictions have also been documented for multiple stocks along the European Union regulatory areas [@Baudron:2020dj], the Benguela Current [@Potts:2014bq; @Yemane:2014jg], and the southwest South Atlantic Ocean [@Franco:2020bk].*
...
- **Response:** Thank you for your comment. We provide direction of change in the next figure (Figure 5 of the revised manuscript) showing winners and losers according to neighboring EEZs. This analysis is based on the time of emergence result, that has no direction, we show how each neighboring EEZ will stand to win or lose against its neighbors.
...
- **Response:** Thank you for noticing this. We have modified this sentence in the revised manuscript with the hopes to make it less jargon-y. It now reeds on line *XX* of *XXX* the revised manuscript: "*There will be an increase in the number of stocks changing their catch proportion and the number of EEZs with changing stocks towards the mid-21st century. Such increase will be followed by an also increase in the intensity of the proportion change (Figs. S3 and S4).*" 
...
- **Response:** Thank you for this comment. We have edited the paragraph starting at line **XXX** of page **XX** to reflect this comment. 
...
- **Response:** We agre and have changed the sentence to reflect this comment.
