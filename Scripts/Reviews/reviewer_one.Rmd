...
- **Response**: [Response completed her and in manuscript] 
...
- Response: Thank you very much for commenting on our figures. Here, we provide responses to the two large scale questions you provide and below we respond the finer scale points. We hope that this clarifies all of your comments. 
 ...
 - **Regarding the bi-lateral agreements**, this is a great question that, unfortunately, we cannot respond at this moment. Currently, there is only one database on bi-lateral agreements produce by Oremus *et al* (2020). On their paper, the authors state "we analysed 27 publicly available international fisheries agreements in the South Pacific, Southeast Asia, South Asia, Northwest Africa, and Central America and the Caribbean" and " For each agreement, we recorded the following information... If relevant, to which specific stock or species the agreement pertained". However, the authors do not provide any information at the stock level and, unfortunately, they never respond/ did not shared their database with us.
...
- *Response:* In the section "High present-day climate risk of on transboundary fisheries management" we describe early shifts in the shared distribution of transboundary stocks including the cases of Humboldt squid (*Dosidicus gigas*) and Atlantic mackerel (*Scomber scombrus*) both in the early 2000s. We have included some more punctual examples of documented shifts between 2006 and 2021. It reads on line **xx** of page **XX**: "Similar shifts have been documented for multiple European stocks [@Baudron:2020dj] like European hake (*Merluccius merluccius*) [@Baudron:2015il] as well as...
...
- **Response:** Thank you for this comment. We have eddited the paragraph starting at line **13** of page **12** to reflect this comment. 
