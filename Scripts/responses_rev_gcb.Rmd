...
- **Response**: Below you will find the response to both Reviewers 1 and 2. In addition, we would like to offer here an explanation of how our paper differs from recent published papers, including those authored by some of us.

  We understand the Editor’s concern as all of these papers look at the consequences of climate change for shared stocks. We have stated the differences between our study and those previously made in the introduction (see below). In short, our manuscript critically builds on the previous studies highlighted, using the species identified by Palacios-Abrantes et al. (2020) *Scientific Reports* and combining methods developed in Sumaila et al. (2020) and Palacios-Abrantes et al. (2020) *Ecology and Society* to address the questions of what is the timeline and intensity of changes in the distribution of current transboundary stocks at the global level? A question that neither Pinsky et al. (2018) *Science* nor Oremus et al. (2020) *Nature Sust*. addressed. Please note that we offer a longer explanation of these differences after the in-text statements. We hope to have clarified the novelty of our research and how it differs from previous studies. The new information that we present here can be critical for fisheries management as it offers tangible reference points at country level around which to consider future climate change impacts and to inform discussions, for instance, around agreements that are relevant to shared stocks.
  
   - Line XX, introduction:  *Recent studies have looked at global gains (Pinsky et. al., 2018) and losses (Oremus et al., 2020) of transboundary stocks within the world’s EEZs as well as regional sharing dynamics between neighbouring countries (Palacios-Abrantes et al., 2020, Sumaila et al., 2020) by the end of the century due to climate change. However, previous studies failed to identify both changes in the distribution of current transboundary stocks at the global level including the actual timeline of shifts in shared stocks and the intensity of such shifts.*
     
  - Line XX, introduction: *We base our analysis on the 633 transboundary species identified by Palacios-Abrantes (2020), defining a ‘stock’ unit as each time a transboundary species is shared by neighboring EEZs.*

  
  In their 2018 paper, Pinsky et al. look at how many new transboundary species will enter each EEZ of the world towards the end of the century under climate change (i.e., national stocks that become transboundary stocks). The authors find that “many of the world’s EEZs are likely to receive one to 12 new, climate-driven transboundary stocks by the end of the century.” On the other hand, Oremus et al. (2020) “estimate the number of species exiting national jurisdictions under climate change up to 2100” concluding that tropical nations stand to lose the most species. Both studies do not identify changes in current transboundary stocks, including the intensity of such shifts, an important knowledge gap that we aim to close in this paper. Here, we build from Palacios-Abrantes et al. (2020) and use the existing no. of transboundary species (n = 633) identified in that earlier paper. This means that, unlike Pinsky et al. (2018) and Oremus et al. (2020) that focus their study on the gaining of new stocks in a EEZ from expansion of distribution of national stocks from other EEZs, or losses of existing stocks from range contraction,  our paper examines the shifts of transboundary stocks  between EEZs that are already sharing the stocks now. These different types of shifts in transboundary stocks are causing different types of impacts on fisheries and would require different sets of adaptation responses [@Pinsky:2014by]. We also identify the timeline of shifts in shared stocks and the intensity of such shifts, which is not explored in previous studies. 
  
To identify the timeline of shifts we adopt the concept of “Time of Emergence” commonly used in oceanic physical and chemical studies (see for example in Rodgers et al. 2015 or Keller et al. 2014), and has just recently been used in ecological studies by Cheung et al. -[@Cheung:2020ja] looking at ecological responses to marine heatwaves and Trisos et al [-@trisos_projected_2020] looking at the timing of species’ exposure to potentially dangerous climate conditions. The “Time of Emergence” is generally defined in the literature as the time when the increase in intensity of the signal exceeds the noise (Bindoff et al. 2019). To our knowledge, no other study has adopted this methodology to look at the time of emergence of shifts in transboundary fisheries. Moreover, to identify the intensity of the shift, we (partially) used methods developed by Palacios et al. (2020) Scientific Reports and Sumaila et al (2020), published in Ecology and society. These papers adopt the concept of threat point to evaluate the resilience of specific treaties celebrated by Canada-US transboundary to manage four transboundary stocks. Here, we further develop this method to apply the concept of threat point to the Stock Share Ratio estimation while expanding the analysis globally to estimate the intensity that the shifts in transboundary stocks will have as well as their time of emergence.
...
- **Response:** We acknowledged that this was not fully clear in the previous version of the manuscript. We have improved the clarity of the definition of the stock unit in the revised manuscript. Specifically, in considering “neighboring stocks of the same species”, for example, Pacific sardine is a species that is present along the coast of Mexico, the United States (US) and, sometimes, British Columbia (BC) [@cisneros-montemayor_ecosystem-based_2020]. For the purpose of our study, we define two stocks: One that is shared by Mexico and the US and one shared by the US and BC. We have made this explicit in the following section of the methods to clarify our definition;
...
- **Response:** Our definition will influence the calculation of SSR between neighboring EEZs (i.e., Mexico and the US SSR for sardine and US and BC SSR for sardine, independently one of another). As the reviewer suggests, in this scenario Mexico could be losing sardine SSR to the US contiguous states (this can also be seen as the US gaining SSR from Mexico), while the US contiguous states loses sardine SSR to BC (again, this could also be seen as Canada winning SSR from the US contiguous states). This is now explained on the methods as follows: 
...
The above are just example situations. I do not mean to be nitpicky about definitions, but I am concerned that the definition of stocks used in this manuscript fundamentally determine the top-line results (e.g., number and proportion of shifting stocks, calculation of the transboundary index and time of emergence, loss or gain of SSR, etc. etc.).
  ...
  - **Response:** We understand the reviewer’s concern and hope that our responses have clarified our choice of the definition. In addition, in the revised manuscript, we have explained the implications of our choice of the definition of stock unit on our findings and conclusions. (line XX of the revised manuscript):
...
- **Response:** We agree with the reviewer that an un-weighted centroid can severely skew the actual distribution of the species and influence our results. We clarified in the manuscript that we did account for the heterogeneous distribution of fish stocks across their entire range. Specifically, the geographic centroid of each stock is indeed weighted by the abundance of the stock. The DBEM uses the species probability of occurrence to estimate the biomass of the species at each 0.5 x 0.5 gridcell as indicated from lines XX to XX of the methods. The centroid of a transboundary stock was determined by the average latitude and longitude ($lon_{ts}$) of the grid cells holding the specified percentile  ($per^{th}$)  of the projected transboundary stock abundance (see below). Thus, we determined the centroid of the stock using only those regions where abundance was higher (i.e., using the probability of occurrence of the DBEM). Moreover, we estimated the sensitivity of our results to the (arbitrarily) percentile threshold $per^{th} = 95^{th}$ as described in lines XX and shown in Figure S6 of the supplements. It reads as follows in line XX:
