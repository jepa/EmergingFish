...
- **Response:   (INCOMPLETE)** This is a very good observation and we believe it has increased the impact of our manuscript. We have included two new figures (**Supplement Figures XX and XX**) showing the average range shift and SSR of the top 5 most valuable transboundary stocks per country (Please note that figure 4 has been removed from the revised manuscript).
...
- **Response:** This is indeed the definition of our stock. We do not deferenciate between transboundary and straddling stocks as per defined in Palacios-Abanes *et al.* (2020). Please refer to our responses to the main comment.

Line 79: where is “this study's definition of a transboundary stock?”

- **Response:** Please see responses to the reviewer's main comments. We have defined a transboundary stock as follows;
